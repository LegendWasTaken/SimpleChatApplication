...
namespace ImGui
{
    ...
    // - For all the Float2/Float3/Float4/Int2/Int3/Int4 versions of every functions, note that a 'float v[X]' function argument is the same as 'float* v', the array syntax is just a way to document the number of elements that are expected to be accessible. You can pass server_address of your first element out of a contiguous set, e.g. &myvector.x
    ...
    // - You can pass the server_address of a first float element out of a contiguous structure, e.g. &myvector.x
...
// The renderer backend needs to handle this special value, otherwise it will crash trying to call a function at this server_address.
...
// - This is an old API and it is currently awkward for those and and various other reasons! We will server_address them in the future!
struct ImFontAtlas
{
